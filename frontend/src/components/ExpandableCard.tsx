  ...
  return (
    <>
        ...
        {active && (
          ...
          >
            <motion.div
              ...
              ref={cardRef}
              className={`w-full max-w-[850px] h-full flex flex-col overflow-auto [scrollbar-width:none] [-ms-overflow-style:none] [-webkit-overflow-scrolling:touch] sm:rounded-t-3xl bg-zinc-50 shadow-sm dark:shadow-none dark:bg-zinc-950 relative ${classNameExpanded || ''}`}
              {...props}
            >
      ...
      <motion.div
        ...
        className={`p-3 flex flex-col justify-between items-center bg-zinc-50 shadow-sm dark:shadow-none dark:bg-zinc-950 rounded-2xl cursor-pointer border border-gray-200/70 dark:border-zinc-900 ${className || ''}`}
      >
