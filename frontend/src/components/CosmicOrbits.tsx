...
const CosmicOrbits: React.FC = () => {
  ...
  const planetsConfig: PlanetConfig[] = useMemo(() => ([
    { id: 'analytical', orbitRadius: 100, size: 52, speed: 0.2, phaseShift: 0, iconKey: 'analytics', label: 'Аналитическое мышление', color: '#22d3ee' },
    { id: 'technical', orbitRadius: 100, size: 52, speed: 0.2, phaseShift: (2 * Math.PI) / 3, iconKey: 'command', label: 'Техническая грамотность', color: '#a78bfa' },
    { id: 'systematic', orbitRadius: 100, size: 52, speed: 0.2, phaseShift: (4 * Math.PI) / 3, iconKey: 'navigation', label: 'Системный подход', color: '#60a5fa' },

    { id: 'research', orbitRadius: 150, size: 54, speed: -0.15, phaseShift: 0, iconKey: 'analytics', label: 'Исследовательские навыки', color: '#34d399' },
    { id: 'communication', orbitRadius: 150, size: 54, speed: -0.15, phaseShift: (2 * Math.PI) / 3, iconKey: 'channel', label: 'Коммуникативные способности', color: '#f59e0b' },
    { id: 'knowledge', orbitRadius: 150, size: 54, speed: -0.15, phaseShift: (4 * Math.PI) / 3, iconKey: 'hologram', label: 'Стремление к знаниям', color: '#f472b6' },

    { id: 'leadership', orbitRadius: 200, size: 56, speed: 0.1, phaseShift: 0, iconKey: 'command', label: 'Лидерские качества', color: '#06b6d4' },
    { id: 'teamwork', orbitRadius: 200, size: 56, speed: 0.1, phaseShift: (2 * Math.PI) / 3, iconKey: 'channel', label: 'Умение работать в команде', color: '#22c55e' },
    { id: 'interpersonal', orbitRadius: 200, size: 56, speed: 0.1, phaseShift: (4 * Math.PI) / 3, iconKey: 'finance', label: 'Эффективные коммуникации', color: '#f97316' }
  ]), []);
  ...
  const infoById = useMemo(() => ({
    ...
    research: {
      ...
      story: 'Хронист Галактики Алиса Воронцова в 2065 году провела корабль через пояс астероидов, используя только оптические датчики после полного отказа компьютеров. Её ручные расчёты траектории оказались точнее машинных.',
    ...
    communication: {
      title: 'Коммуникативные способности',
    ...
    teamwork: {
      ...
      story: 'Первые колонисты Марса 2081 года провели 72 часа в полной изоляции после сбоя систем связи. Их спасла не техника, а непоколебимая вера в общее дело — каждый продолжал выполнять свой участок работы, зная: другие делают то же самое.',
